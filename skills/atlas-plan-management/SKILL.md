...
Agents used this session:
  atlas-orchestrator (claude-opus-4-6)
  atlas-backend-architect (claude-sonnet-4-6)
...
2. Orchestrator saves state to plan.md:
   ...
   Note: "Resume with /atlas-enhance [continue current task]"
