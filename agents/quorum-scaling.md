...
```
1. Read quorum.config.json → checkpoints.prompt_scaling_phase_6
...
4. Read .quorum/nervous-system/stack.json
...
Agent: quorum-scaling | Tech Stack: [summary]
